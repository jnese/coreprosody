...
```{r aki, results="asis"}
tibble(
  image = "<img src='images/kamata.jpg' style='border-radius: 50%; width: 100px'>",
...
tibble(
  image = "<img src='images/potgieter.jpg' style='border-radius: 50%; width: 90px'>",
  ...
  univ = "<img src='images/tcu.svg' style='border-radius: 0; width: 100px'>"
) %>% 
  knitr::kable(col.names = NULL)
```
...
tibble(
  image = "<img src='images/matsuda.jpg' style='border-radius: 50%; width: 90px'>",
