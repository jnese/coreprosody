...
```{r fig.cap="From [Daane, Campbell, Grigg, Goodman, & Oranje (2005)](https://nces.ed.gov/nationsreportcard/pdf/studies/2006469.pdf)"}

knitr::include_graphics(here::here("docs", "images", "naep_rubric.png"))
...
```{r fig.cap="From [Rasinski, Rikli, & Johnston (2009)](https://www.tandfonline.com/doi/pdf/10.1080/19388070802468715)"}
#fig.width=6, fig.height=1.5
knitr::include_graphics(here::here("docs", "images", "mfsg_rubric.png"))
```
...
```{r core_rubric}
#layout="l-page"
knitr::include_graphics(here::here("docs", "images", "core-ii_rubric.png"))
```
...
```{r fig.cap=""}
knitr::include_graphics(here::here("docs", "images", "task_7steps.png"))
```
