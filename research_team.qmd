...
```{r nafisul, results="asis"}
tibble(
  image = "<img src='images/nafisul.jpg' style='border-radius: 50%; width: 100px'>",
  name = "**Nafisul Huq**<a href='mailto:nhuq@uoregon.edu'> <i class='fa fa-envelope'></i></a><br>Graduate Researcher<br>",
  univ = "<img src='images/UOSignature-BAR-3435.jpg' style='border-radius: 0; width: 100px'>"
) %>% 
  knitr::kable(col.names = NULL)
```

Nafisul Huq is a Master’s student in Data Science at the University of Oregon. His research focuses on psychometrics and quantitative measurement.

For Core + Prosody, Nafisul collaborated with Dr. Joe Nese to
assess the [feasibility of use](https://jnese.github.io/coreprosody/feasibility.html) of the project’s ORF estimates.
